...
CrearPdf(item) {
  ...
  convertirPdfMixta(item) {
    ...
    debugger;
    this.objPdf.CantidadEncontrados = item.count
    this.objPdf.documento = item.snumdoC_BUSQUEDA
    this.objPdf.nombre = item.snombrE_BUSQUEDA
    ...
    document.getElementById("fecha").innerHTML = item.dfechA_BUSQUEDA;
    document.getElementById("nombre").innerHTML = item.susuariO_BUSQUEDA;
    document.getElementById("perfil").innerHTML = this.DataUserLogin.SNAME;
    document.getElementById("cargo").innerHTML = this.DataUserLogin.SDESCARGO;
    document.getElementById("email").innerHTML =  this.DataUserLogin.SEMAIL;
   ...
   document.getElementById('reporte').classList.remove('ocultarReporte')
