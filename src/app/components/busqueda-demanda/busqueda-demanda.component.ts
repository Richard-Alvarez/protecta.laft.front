...
CrearPdf(){
  ...
  var SeparacionCabecera =  50
    ...
    doc.setFontSize(14);
    doc.text('Persona que se realizó la búsqueda: ',tamañoCabecera,SeparacionCabecera + 40);
    ...
    autoTable(doc, {
      ...
      // columnStyles: { 0: { halign: 'center', fillColor: [0, 255, 0] } },
      headStyles: {fontSize: 9},
      bodyStyles: {fontSize: 8,lineColor:'#FA8072'},
      columnStyles: { 5: { halign: 'center'} },
      margin: {top: 95,left:30,right:50},
      head: columns,
      body: data,
      didDrawCell: (data) => { 
